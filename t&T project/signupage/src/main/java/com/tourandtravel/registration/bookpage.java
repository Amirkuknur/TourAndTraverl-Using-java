...
public class bookpage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String jdbcUrl = "jdbc:mysql://localhost:3306/indianbook";
        String dbUser = "root";
        ...
        try {
            ...
            String sql = "INSERT INTO Bookings (name, email, destination, rooms, adults, children) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            response.sendRedirect("paymentpage.jsp"); // Replace "confirmation.jsp" with your confirmation page
